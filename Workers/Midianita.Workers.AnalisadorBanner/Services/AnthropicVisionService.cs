...
<<<<<<< HEAD
        "5. ZERO TYPOGRAPHY RULE (CRITICAL): Absolutely DO NOT describe any text, letters, words, or typography present in the reference image. If the reference features giant background letters, you MUST reinterpret and describe them as 'clean, uncluttered negative space' or 'abstract solid geometric blocks'. The words 'text', 'letter', 'font', or 'typography' MUST NOT exist anywhere in your descriptive output. " +
=======
...
<<<<<<< HEAD
        "IRONCLAD NEGATIVE PROMPT (MANDATORY): You MUST append this exact sentence to the very end of your `masterPrompt`: 'CRITICAL CONSTRAINT: DO NOT generate any text, letters, words, numbers, watermarks, or typography of any kind. The composition must remain 100% text-free and clean.' " +
=======
